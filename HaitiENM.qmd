...
```{r}
#| label: Generate-vulnerability-choropleths
#| code-summary: "Create interactive vulnerability index maps with scenario switching"
#| echo: false
#| warning: false
#| include: true
...
# Function for min-max scaling (0-1 normalization)
min_max_scale <- function(x) {
  (x - min(x, na.rm = TRUE)) / (max(x, na.rm = TRUE) - min(x, na.rm = TRUE))
}

# Create composite vulnerability index using min-max scaling
Haiti_adm3_vuln <- Haiti_adm3_with_stats %>%
  mutate(
    # Calculate population density (persons per km²)
    area_km2 = as.numeric(st_area(.) / 1000000),
    pop_density_2020 = ifelse(area_km2 > 0, total_population_2020 / area_km2, 0),
    
    # Min-max normalization (0-1 scaling) for each scenario
    norm_mean_baseline_suitability = min_max_scale(mean_baseline_suitability),
    norm_mean_suitability_1_5C = min_max_scale(mean_suitability_1_5C),
    norm_mean_suitability_2C = min_max_scale(mean_suitability_2C),
    norm_mean_suitability_3C = min_max_scale(mean_suitability_3C),
    norm_mean_suitability_4C = min_max_scale(mean_suitability_4C),
    
    # Normalize population density and IDP count
    norm_pop_density = min_max_scale(pop_density_2020),
    norm_idp_count = min_max_scale(total_idp_persons),
    
    # Create composite vulnerability indices (equal weighting, bounded 0-1)
    vuln_index_baseline = (norm_mean_baseline_suitability + norm_pop_density + norm_idp_count) / 3,
    vuln_index_1_5C = (norm_mean_suitability_1_5C + norm_pop_density + norm_idp_count) / 3,
    vuln_index_2C = (norm_mean_suitability_2C + norm_pop_density + norm_idp_count) / 3,
    vuln_index_3C = (norm_mean_suitability_3C + norm_pop_density + norm_idp_count) / 3,
    vuln_index_4C = (norm_mean_suitability_4C + norm_pop_density + norm_idp_count) / 3
  )

# Create colorblind-friendly reddish-gold palette
gold_red_colors <- c("#FFF7BC", "#FED976", "#FEB24C", "#FD8D3C", "#FC4E2A", "#E31A1C", "#BD0026", "#800026")

# Function to create multi-scenario vulnerability map
create_multi_scenario_map <- function(data, level = "Section") {
  
  # Get all vulnerability values across all scenarios for consistent color scale
  all_vuln_values <- c(
    data$vuln_index_baseline,
    data$vuln_index_1_5C,
    data$vuln_index_2C,
    data$vuln_index_3C,
    data$vuln_index_4C
  )
  
  # Create consistent color palette across all scenarios
  pal <- colorNumeric(
    palette = gold_red_colors,
    domain = all_vuln_values,
    na.color = "transparent"
  )
  ...
  map <- map %>%
    addPolygons(
      fillColor = ~pal(vuln_index_baseline),
      fillOpacity = 0.8,
      color = "white",
      weight = if(level == "Section") 0.5 else 1,
      opacity = 1,
      group = "Baseline",
      highlightOptions = highlightOptions(
        weight = 2,
      ...
      popup = ~paste0(
        ...
        if(level == "Section") ADM3_EN else ADM2_EN, "</h4>",
        "<hr style='margin: 5px 0;'>",
        "<b>Administrative Info:</b><br>",
        if(level == "Section") paste0("Section: ", ADM3_EN, "<br>") else "",
        "Commune: ", if(level == "Section") ADM2_EN else ADM2_EN, "<br>",
        "Department: ", ADM1_EN, "<br>",
        "P-code: ", if(level == "Section") ADM3_PCODE else ADM2_PCODE, "<br><br>",
        "<b>Risk Index - BASELINE:</b><br>",
        "<span style='font-size: 14px; font-weight: bold; color: #d73027;'>", 
        round(vuln_index_baseline, 3), "</span><br><br>",
        "<b>Index Components:</b><br>",
        "<i>Aedes aegypti</i> Suitability: ", round(norm_mean_baseline_suitability, 3), "<br>",
        "Population Density: ", round(norm_pop_density, 3), "<br>",
        "IDP Count: ", round(norm_idp_count, 3), "<br><br>",
        "<b>Raw Values:</b><br>",
        "Population (2020): ", scales::comma(total_population_2020), "<br>",
        "IDPs: ", scales::comma(total_idp_persons), "<br>",
        "Pop. Density: ", round(pop_density_2020, 1), " per km²<br>",
        "</div>"
      ),
      label = ~if(level == "Section") paste0(ADM3_EN, " (", ADM2_EN, ")") else paste0(ADM2_EN, " (", ADM1_EN, ")")
    )
  
  # Add 1.5°C scenario
  map <- map %>%
    addPolygons(
      fillColor = ~pal(vuln_index_1_5C),
      fillOpacity = 0.8,
      color = "white",
      weight = if(level == "Section") 0.5 else 1,
      opacity = 1,
      ...
      popup = ~paste0(
        ...
        "Department: ", ADM1_EN, "<br>",
        "P-code: ", if(level == "Section") ADM3_PCODE else ADM2_PCODE, "<br><br>",
        "<b>Risk Index - 1.5°C WARMING:</b><br>",
        "<span style='font-size: 14px; font-weight: bold; color: #d73027;'>", 
        round(vuln_index_1_5C, 3), "</span><br><br>",
        "<b>Index Components:</b><br>",
        "<i>Aedes aegypti</i> Suitability: ", round(norm_mean_suitability_1_5C, 3), "<br>",
        "Population Density: ", round(norm_pop_density, 3), "<br>",
        "IDP Count: ", round(norm_idp_count, 3), "<br><br>",
        "<b>Raw Values:</b><br>",
        "Population (2020): ", scales::comma(total_population_2020), "<br>",
  ...
  map <- map %>%
    addPolygons(
      ...
      popup = ~paste0(
        ...
        "Department: ", ADM1_EN, "<br>",
        "P-code: ", if(level == "Section") ADM3_PCODE else ADM2_PCODE, "<br><br>",
        "<b>Risk Index - 2°C WARMING:</b><br>",
        "<span style='font-size: 14px; font-weight: bold; color: #d73027;'>", 
        round(vuln_index_2C, 3), "</span><br><br>",
        "<b>Index Components:</b><br>",
        "<i>Aedes aegypti</i> Suitability: ", round(norm_mean_suitability_2C, 3), "<br>",
        "Population Density: ", round(norm_pop_density, 3), "<br>",
        "IDP Count: ", round(norm_idp_count, 3), "<br><br>",
        "<b>Raw Values:</b><br>",
        "Population (2020): ", scales::comma(total_population_2020), "<br>",
  ...
  map <- map %>%
    addPolygons(
      ...
      popup = ~paste0(
        ...
        "Department: ", ADM1_EN, "<br>",
        "P-code: ", if(level == "Section") ADM3_PCODE else ADM2_PCODE, "<br><br>",
        "<b>Risk Index - 3°C WARMING:</b><br>",
        "<span style='font-size: 14px; font-weight: bold; color: #d73027;'>", 
        round(vuln_index_3C, 3), "</span><br><br>",
        "<b>Index Components:</b><br>",
        "<i>Aedes aegypti</i> Suitability: ", round(norm_mean_suitability_3C, 3), "<br>",
        "Population Density: ", round(norm_pop_density, 3), "<br>",
        "IDP Count: ", round(norm_idp_count, 3), "<br><br>",
        "<b>Raw Values:</b><br>",
        "Population (2020): ", scales::comma(total_population_2020), "<br>",
  ...
  map <- map %>%
    addPolygons(
      ...
      popup = ~paste0(
        ...
        "Department: ", ADM1_EN, "<br>",
        "P-code: ", if(level == "Section") ADM3_PCODE else ADM2_PCODE, "<br><br>",
        "<b>Risk Index - 4°C WARMING:</b><br>",
        "<span style='font-size: 14px; font-weight: bold; color: #d73027;'>", 
        round(vuln_index_4C, 3), "</span><br><br>",
        "<b>Index Components:</b><br>",
        "<i>Aedes aegypti</i> Suitability: ", round(norm_mean_suitability_4C, 3), "<br>",
        "Population Density: ", round(norm_pop_density, 3), "<br>",
        "IDP Count: ", round(norm_idp_count, 3), "<br><br>",
        "<b>Raw Values:</b><br>",
        "Population (2020): ", scales::comma(total_population_2020), "<br>",
...
# ============== COMMUNE LEVEL VULNERABILITY ANALYSIS ==============
Haiti_adm2_aggregated <- Haiti_adm3_vuln %>%
  st_drop_geometry() %>%
  group_by(ADM2_EN, ADM2_PCODE, ADM1_EN, ADM1_PCODE) %>%
  summarise(
    mean_baseline_suitability = weighted.mean(mean_baseline_suitability, total_population_2020, na.rm = TRUE),
    mean_suitability_1_5C = weighted.mean(mean_suitability_1_5C, total_population_2020, na.rm = TRUE),
    mean_suitability_2C = weighted.mean(mean_suitability_2C, total_population_2020, na.rm = TRUE),
    mean_suitability_3C = weighted.mean(mean_suitability_3C, total_population_2020, na.rm = TRUE),
    mean_suitability_4C = weighted.mean(mean_suitability_4C, total_population_2020, na.rm = TRUE),
...
Haiti_adm2_vuln <- Haiti_adm2_boundaries %>%
  dplyr::select(ADM2_EN, ADM2_PCODE, ADM1_EN, ADM1_PCODE) %>%
  left_join(Haiti_adm2_aggregated, by = c("ADM2_EN", "ADM2_PCODE", "ADM1_EN", "ADM1_PCODE")) %>%
  mutate(
    pop_density_2020 = ifelse(area_km2 > 0, total_population_2020 / area_km2, 0),
    
    # Min-max normalization at commune level
    norm_mean_baseline_suitability = min_max_scale(mean_baseline_suitability),
    norm_mean_suitability_1_5C = min_max_scale(mean_suitability_1_5C),
    norm_mean_suitability_2C = min_max_scale(mean_suitability_2C),
    norm_mean_suitability_3C = min_max_scale(mean_suitability_3C),
    ...
    # Calculate bounded vulnerability indices
    vuln_index_baseline = (norm_mean_baseline_suitability + norm_pop_density + norm_idp_count) / 3,
    vuln_index_1_5C = (norm_mean_suitability_1_5C + norm_pop_density + norm_idp_count) / 3,
    vuln_index_2C = (norm_mean_suitability_2C + norm_pop_density + norm_idp_count) / 3,
    vuln_index_3C = (norm_mean_suitability_3C + norm_pop_density + norm_idp_count) / 3,
...
section_vulnerability_map <- create_multi_scenario_map(Haiti_adm3_vuln, "Section")
commune_vulnerability_map <- create_multi_scenario_map(Haiti_adm2_vuln, "Commune")

# Assign to global environment
assign("Haiti_adm3_vuln", Haiti_adm3_vuln, envir = .GlobalEnv)
assign("Haiti_adm2_vuln", Haiti_adm2_vuln, envir = .GlobalEnv)

# Display maps
section_vulnerability_map
commune_vulnerability_map
